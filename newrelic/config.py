...
def _process_module_builtin_defaults():
    ...
    _process_module_definition("asyncio.tasks", "newrelic.hooks.coroutines_asyncio", "instrument_asyncio_tasks")
    _process_module_definition("asyncio", "newrelic.hooks.coroutines_asyncio", "instrument_asyncio")
    _process_module_definition("uvloop", "newrelic.hooks.coroutines_asyncio", "instrument_uvloop")
